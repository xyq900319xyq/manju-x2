...
description: "从剧本中提取人物、场景、物品资产，并设计全中文AI生图指令词（对标魔因漫创指令格式）。"
version: 2.2.0
category: creative
---
...
从剧本中提取所有视觉资产——人物、场景、物品——并为每个资产生成可直接用于AI绘图工具的中文指令词，格式对标魔因漫创（Moyin Creator）的生图指令体系。
...
## 人物资产条目格式（对标魔因角色设定图 characterSeed）
